    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('lector', 'Lector'), ('bibliotecario', 'Bibliotecario')], default='lector', help_text='Rol del usuario en el sistema', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('disponible', 'Disponible'), ('prestado', 'Prestado'), ('retrasado', 'Retrasado')], default='disponible', max_length=15)),
